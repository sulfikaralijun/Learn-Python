...
Anda juga dapat mengubah nilai pada variabel walaupun tipe datanya berbeda tetapi **disarankan tidak melakukan hal ini, karena bukan cara yang efektif**, contohnya:
```python
age = 17
age = 'tujuh belas'
```
